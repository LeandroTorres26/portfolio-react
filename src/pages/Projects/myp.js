    ...
    <motion.section initial="out" animate="in" exit="out" variants={pageTransition}>
      ...
      <div className={styles.project}>
        ...
        <p className={styles.project__desc}>
          ...
          relationship website (similar to Tinder) for pets. The user after logging into their account can search for a
          partner for their pets or adopt a new one. All conversations and negotiations on the website are made through
          a text chat.
        </p>
